...
data class Character(
    ...
    val listCharacter = listOf(
        ...
        Character(5,R.drawable.kazuha,"Kadehara Kazuha","Inazuma","Samurai pengembara dari Inazuma, bersifat lemah lembut dan rendah hati.\n" +
                "Di balik penampilannya yang muda dan cuek ternyata tersembunyi banyak kepahitan masa lalu. Meski selalu terlihat santai, dia memiliki prinsip tersendiri dalam bertindak.","anemo"),
        Character(6,R.drawable.heizou,"Heizou","Inazmua","Seorang detektif muda dari Tenryou Commission. Memiliki intuisi yang kuat dan pemikiran yang tajam. Tidak peduli apa pun kasus yang dia hadapi, dia dapat menemukan kebenarannya dengan cara yang tak terduga.","anemo"),
        Character(7,R.drawable.nahida,"Nahida","Sumeru","Lesser Lord Kusanali yang tinggal di Sanctuary of Surasthana, selalu dipandang remeh dan jarang dibicarakan orang-orang. \n" +
                "Dia memikul beban yang berat, meskipun selalu diselimuti dalam kegelapan dan kesepian, dia tidak pernah berhenti melangkah maju.","dendro"),
        Character(8,R.drawable.nilou,"Nilou","Sumeru","Bintang Teater Zubayr, seorang penari yang anggun seperti bunga teratai yang baru mekar tanpa sedikit pun noda.\n Namun, dia sama sekali tidak angkuh dan dingin. Bahkan seorang petualang yang terburu-buru tidak dapat melupakan senyumnya yang tulus dan berseri-seri.","hydro"),
        Character(9,R.drawable.charlotte,"Charlotte","Fontaine","Seorang reporter dari The Steambird yang selalu terlihat sangat bersemangat. Ia tidak pernah berhenti berlari ke sana kemari untuk mencari \"kebenaran\".","cryo"),
        Character(10,R.drawable.neuvillate,"Neuvillete","Fontaine","Sang Iudex Fontaine bisa dibilang adalah seseorang yang \"sulit didekati\". Entah karena sifatnya, atau karena ada rahasia yang disembunyikannya.","hydro")
    )
